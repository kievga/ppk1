...
namespace order_coffe
{
    public partial class CheckOut : Form
    {
        ...
        private void Button_refresh_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM `stgk_sementara` INNER JOIN stgk_pemesanan ON stgk_sementara.id_pembeli = stgk_pemesanan.id_pemesanan INNER JOIN stgk_menu ON stgk_menu.id_menu = stgk_sementara.id_menu WHERE id_pembeli = @id_pembeli;";
            try
            {
                // Open the database
                databaseConnection.Open();
        ...
        private void button_bayar_Click(object sender, EventArgs e)
        {
            ...
            bayar = Convert.ToDouble(text_bayar.Text);
            total = Convert.ToDouble(label_total.Text);
            kembali = total - bayar;
            label_kembali.Text = kembali.ToString();
        }
